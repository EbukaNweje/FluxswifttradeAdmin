...
const AddManager = () => {
  ...
  const getallDeposit = () => {
    const url =
      "https://fluxswifttrade-back-end-two.vercel.app/api/getallWalletAddress";
    axios
      .get(url)
      .then((response) => {
  ...
  const handleDelete = (walletId) => {
    ...
    const url = `https://fluxswifttrade-back-end-two.vercel.app/api/deleteWalletAddress/${walletId}`;
    axios
      .delete(url)
      .then((res) => {
        console.log(res);
